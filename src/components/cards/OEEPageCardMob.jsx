...
export default function OEEPageCardMob({ conveyor, pump, live }) {
  ...
  return (
    <div
      ...
      style={{
        width: "600px", // LOCK width here
        transform: "scale(var(--mobScale))",
        transformOrigin: "top center", // optional
      }}
    >
      <Card className="p-4 mx-3 my-1 w-auto h-full relative overflow-hidden gap-0">
        ...
        <div className="grid grid-cols-3 gap-4 mt-1 m-4">
          {/* Machine status card */}
          <div className="">
          ...
          {/* Water tank card */}
          <div className="justify-self-end bg-zinc-50 shadow-sm rounded gap-1 h-auto w-[170px] p-2 min-h-[160px]">
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="h-fit">
                <div className="relative">
                  <div className="absolute scale-45 inset-0">
          ...
          {/* OEE card */}
          <div className="col-span-3 relative min-h-[190px]">
